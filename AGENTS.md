# Keel v5.20.0 Agent Protocol

<!-- keel:start version=5.20.0 -->
## Session Start
...
- If this repo is missing or partially missing the v5.20.0 protocol, prompt before install and suggest keel --init --target <target>.
<!-- keel:end -->
