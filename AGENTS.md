...
- If this repo is missing or partially missing the v5.14.0 protocol, prompt before install and suggest keel --init --target <target>.
<!-- keel:end -->
