# Keel v5.3.2 Agent Protocol

<!-- keel:start version=5.3.2 -->
## Session Start
...
- If this repo is missing or partially missing the v5.3.2 protocol, prompt before install and suggest keel --init --target <target>.
<!-- keel:end -->
