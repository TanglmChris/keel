...
- If this repo is missing or partially missing the v5.3.5 protocol, prompt before install and suggest keel --init --target <target>.
<!-- keel:end -->
