...
- If this repo is missing or partially missing the v5.1.1 protocol, prompt before install and suggest keel --init --target <target>.
<!-- keel:end -->
