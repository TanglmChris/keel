...
Define how a repository declares who merges into its default branch, how Keel reports that declaration
where a session starts, why a claim that nobody reviews must name what replaced the reviewer, and why the
declaration grants the agent nothing.
