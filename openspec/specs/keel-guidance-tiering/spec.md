...
Define how a skill's stepwise guidance is delivered separately from its criteria, how a repository
declares that it does not need that guidance, why the declaration cannot reach anything but guidance,
and what happens when the declaration cannot be read.
