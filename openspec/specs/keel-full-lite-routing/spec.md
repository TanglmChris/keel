# keel-full-lite-routing

## Purpose

Define how the Full/Lite routing rule reaches the agent that makes the decision, how a project declares the paths the size heuristic gets wrong, what happens when that declaration cannot be read, and why Keel carries routing rather than gating it.
