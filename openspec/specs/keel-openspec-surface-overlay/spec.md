...
Define Keel's managed overlay for the OpenSpec-generated target surfaces of every action in the managed set — propose, apply, archive, and sync — and the target-native subagent gate.
## Requirements
